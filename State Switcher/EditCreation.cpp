...
const char* EditCreation::GetDescription(ArgScript::DescriptionMode mode) const
{
	if (mode == ArgScript::DescriptionMode::Basic) {
		return "This cheat lets you enter any creation into a specified editor, using either its name found in .package files or an alias.";
	}
	else {
		...
		*str = "\n"
			"Usage: editcreation (editorName) [-noAlias/-alias] [-hash]\n"
			"List of aliases:\n";
